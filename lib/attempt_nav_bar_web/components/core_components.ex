defmodule AttemptNavBarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AttemptNavBarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AttemptNavBarWeb.Gettext, "errors", msg, opts)
    end
  end
